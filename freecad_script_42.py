...
foundation = Part.makeBox(10000.0, 2000.0, 600.0)
foundation_obj = doc.addObject("Part::Feature", "Foundation")
foundation_obj.Shape = foundation

outer_wall = Part.makeBox(10000.0, 2000.0, 5000.0)
...
roof = Part.makeBox(10000.0, 2000.0, 100)
...
doc.recompute()
doc.saveAs(r"3d_model\Центр_обработки_данных.FCStd")
