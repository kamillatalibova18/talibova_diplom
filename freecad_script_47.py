...
outer_wall = Part.makeBox(10000.0, 7000.0, 5000.0)
...
roof = Part.makeBox(10000.0, 7000.0, 100)

roof_obj = doc.addObject("Part::Feature", "Roof")
roof_obj.Shape = roof
roof_obj.Placement.Base = FreeCAD.Vector(0,0,5000.0)

doc.recompute()
doc.saveAs(r"3d_model\Узел_техконтроля.FCStd")
