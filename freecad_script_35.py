...
foundation = Part.makeBox(3000.0, 2000.0, 300.0)
foundation_obj = doc.addObject("Part::Feature", "Foundation")
foundation_obj.Shape = foundation

outer_wall = Part.makeBox(3000.0, 2000.0, 3000.0)
inner_wall = Part.makeBox(
    3000.0-2*200.0, 
    2000.0-2*200.0, 
    3000.0-300.0
)
inner_wall.translate(FreeCAD.Vector(200.0, 200.0, 300.0))
walls = outer_wall.cut(inner_wall)
walls_obj = doc.addObject("Part::Feature", "Walls")
walls_obj.Shape = walls

points = [FreeCAD.Vector(0,0,0), FreeCAD.Vector(3000.0/2,0,3000.0/2), FreeCAD.Vector(3000.0,0,0)]
...
doc.recompute()
doc.saveAs(r"3d_model\дача1.FCStd")
